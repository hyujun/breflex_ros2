...
namespace
{
  ...
  std::shared_ptr<breflex::MuJoCoMessageHandler::ActuatorCmds> actuator_cmds_ptr;
...
int main(int argc, char **argv)
{
  ...
  auto message_handle =
      std::make_shared<breflex::MuJoCoMessageHandler>(sim.get());
  actuator_cmds_ptr = message_handle->get_actuator_cmds_ptr();
  auto spin_func = [](std::shared_ptr<breflex::MuJoCoMessageHandler> node_ptr)
  {
